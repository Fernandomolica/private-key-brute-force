...
function findMatchingSHA256(startkey, stopkey, P2PKH) {
    ...
    console.log(`From "0x020000000000000000" to "0x03ffffffffffffffff"`)
        ...
        while(true){
            ...
            for(let i = 0 ; i < byteLength ; i++){
                ...
                if(i===0){
                    ...
                    newByteString02 = newByteString02+byte.toString(16).padStart(2, '0')
                    newByteString03 = newByteString03+byte.toString(16).padStart(2, '0')
                }
            }
    
            if(getP2PKHcompressed(newByteString02.padStart(64, '0')) === P2PKH) {
    
                const solution = {
    
                    p2pkh: getP2PKHcompressed(newByteString02.padStart(64, '0')),
                    privateKey: newByteString02.padStart(64, '0')
                }
                ...
                fs.writeFile(solutionPath, JSON.stringify(solution), 'utf-8', err=>{
                    if(err){
                        ...
                        console.log("Done! You are milionaire")
                        console.log(newByteString02.padStart(64, '0'))
                        console.log(getP2PKHcompressed(newByteString02.padStart(64, '0')))
                    }
                })

                return solution
            }else if(getP2PKHcompressed(newByteString03.padStart(64, '0')) === P2PKH) {
    
                const solution = {
    
                    p2pkh: getP2PKHcompressed(newByteString03.padStart(64, '0')),
                    privateKey: newByteString03.padStart(64, '0')
                }
                ...
                fs.writeFile(solutionPath, JSON.stringify(solution), 'utf-8', err=>{
                    if(err){
                        ...
                        console.log("Done! You are milionaire")
                        console.log(newByteString03.padStart(64, '0'))
                        console.log(getP2PKHcompressed(newByteString03.padStart(64, '0')))
                    }
                })
